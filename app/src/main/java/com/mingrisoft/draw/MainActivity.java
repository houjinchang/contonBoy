...
import com.mingrisoft.draw.view.SatelliteMenu;
            ...
            public void onClick(View view, int pos) {
                ...
                if(pos==1){
                    ...
                    countTili.setText(Integer.valueOf(countTili.getText().toString()).intValue()+1+"");
                            Toast.makeText(MainActivity.this, "体力+1", Toast.LENGTH_SHORT).show();
                }
                else if(pos==3){
                    countArt.setText(Integer.valueOf(countArt.getText().toString()).intValue()+1+"");
                    Toast.makeText(MainActivity.this,"见识+1",Toast.LENGTH_SHORT).show();
                }
            }
        });
